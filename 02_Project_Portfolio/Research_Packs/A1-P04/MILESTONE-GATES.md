...
**Phải hiểu — riêng đề tài này:** TX/RX timing, why async serial needs sampling strategy, clock mismatch budget, framing/parity errors
...
**Mentor hỏi:** Tại sao UART vẫn nhận được khi hai clock không giống hệt nhau?
...
**Phải dựng — riêng đề tài này:** UART TX, UART RX
...
**Mentor hỏi:** Oversampling cải thiện gì và tốn gì?
...
**Phải dựng — riêng đề tài này:** baud generator, optional oversampling receiver, error detector, self-checking TB + FPGA demo
...
**Mentor hỏi:** Noise model có thực tế không?
...
**Thí nghiệm trọng tâm — riêng đề tài này:** nominal loopback, baud mismatch sweep, sampling offset sweep, error/noise injection, oversampling-factor comparison, resource/timing evaluation
...
**Bằng chứng trọng tâm — riêng đề tài này:** waveforms, pass/fail robustness boundary, BER/framing-error plots, resource report, FPGA demonstration
...
**Mentor hỏi:** Kết quả có vượt mức project thông thường để thành research chưa?
...
**Ngưỡng riêng của đề tài — riêng đề tài này:** Chỉ mở paper nếu có robustness study có hệ thống, comparison với kiến trúc/sampling baseline, quantitative boundary và insight; nếu không thì giữ ở training/engineering output.
