...
| 3 | Thiết kế baseline | Chốt baseline, đầu vào/đầu ra, metric và giao thức thí nghiệm. | Baseline spec + test plan. | Baseline này đã đủ mạnh và công bằng chưa? Tại sao constraint này làm timing/area thay đổi? | Mentor duyệt tính công bằng của baseline. |
...
| 8 | Chốt phương pháp đề xuất | Đóng băng phiên bản đem đi đo; ghi rõ chi phí phát sinh so với baseline. | Bản v2 + bảng so sánh chi phí. | Chi phí mới sinh ra ở đâu? Nếu layout pass DRC nhưng fail LVS nghĩa là gì? | **Gate 3 đạt** (G3). <br>_hạn 01/11/2026_ |
...
| 12 | Phân tích · failure case | Giải thích xu hướng bằng nguyên nhân; tìm và mô tả failure case. | 2–4 hình/bảng + phân tích. | Failure case quan trọng nhất là gì? Kết quả nào là insight chứ không chỉ tool output? | G5 đạt. |
