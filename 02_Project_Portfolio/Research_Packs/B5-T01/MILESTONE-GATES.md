...
**Phải hiểu — riêng đề tài này:** frame label definition, false positive vs false negative, class imbalance, AUC vs operating point
...
**Mentor hỏi:** Label có leakage không?
...
**Phải dựng — riêng đề tài này:** dataset generator from SC, feature extractor
...
**Mentor hỏi:** Feature này có sẵn trước khi quyết định activate không?
...
**Phải dựng — riêng đề tài này:** threshold/rule baseline, evaluation pipeline, optional simple statistical classifier
...
**Mentor hỏi:** False negative gây hậu quả gì?
...
**Thí nghiệm trọng tâm — riêng đề tài này:** feature distribution correct vs error frames, ROC/PR, threshold sweep, activation rate vs miss rate, end-to-end BLER when coupled to oracle/enhanced path
...
**Bằng chứng trọng tâm — riêng đề tài này:** dataset manifest, feature histograms, ROC/PR plots, confusion matrix, activation/BLER trade-off
...
**Mentor hỏi:** Operating point nào tối ưu cho decoder chứ không chỉ classifier?
...
**Ngưỡng riêng của đề tài — riêng đề tài này:** Detector phải tạo end-to-end benefit: giảm activation/average cost trong khi BLER gần target; có baseline, sensitivity và no-leakage validation.
