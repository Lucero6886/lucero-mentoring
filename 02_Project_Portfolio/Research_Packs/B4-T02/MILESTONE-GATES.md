...
**Phải hiểu — riêng đề tài này:** ranking vs classification, candidate-hit rate, top-k accuracy, why low |LLR| may not equal true first error
...
**Mentor hỏi:** Metric mới dùng thông tin nào mà |LLR| không có?
...
**Phải dựng — riêng đề tài này:** failed-frame data collector, candidate feature extractor
...
**Mentor hỏi:** Improvement có còn khi candidate pool thay đổi?
...
**Phải dựng — riêng đề tài này:** baseline |LLR| ranking, proposed handcrafted metric, SCF integration
...
**Mentor hỏi:** Ranking tốt hơn có thực sự cải thiện BLER/latency?
...
**Thí nghiệm trọng tâm — riêng đề tài này:** Top-1/3/5 hit rate, BLER vs SNR, average attempts, metric complexity, sensitivity to candidate pool/Tmax
...
**Bằng chứng trọng tâm — riêng đề tài này:** ranking accuracy table, BLER curves, attempt reduction, failure examples, operation-count/hardware-cost estimate
...
**Mentor hỏi:** Overhead của metric có ăn hết lợi ích không?
...
**Ngưỡng riêng của đề tài — riêng đề tài này:** Có ranking improvement ổn định, end-to-end SCF benefit, complexity analysis và ablation/interpretation rõ.
