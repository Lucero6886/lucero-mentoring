# B1-T02 — Thiết kế và đánh giá f/g Processing Elements cho Polar Decoder

**Engineering & Research Mentoring Program (Lucero)** · ThS. Đinh Văn Nam (Mr. Lucero Dinh) — Khoa Điện–Điện tử, Trường Kỹ thuật, Đại học Phenikaa

> **File sinh tự động** từ `06_Data/research_packs.json` bằng `scripts/generate_research_packs.py`. Sửa tay sẽ bị ghi đè — muốn đổi nội dung thì sửa JSON rồi chạy lại script.

**English:** Design and Evaluation of Processing Elements for Polar Decoders

**Nhóm:** `B1` — Khối phần cứng cho Polar (Polar Hardware Building Blocks)
**Loại:** `T` — Đồ án tốt nghiệp · **Sàn năng lực:** L2 · **Mã ngắn khóa hiện tại:** `B5`
...
Exact/min-sum/reference; fixed-point RTL; timing/area/resource; BLER impact via model
