# A6-T01 — Thiết kế hệ thống nhúng điều khiển và thu thập dữ liệu hoàn chỉnh

**Engineering & Research Mentoring Program (Lucero)** · ThS. Đinh Văn Nam (Mr. Lucero Dinh) — Khoa Điện–Điện tử, Trường Kỹ thuật, Đại học Phenikaa

> **File sinh tự động** từ `06_Data/research_packs.json` bằng `scripts/generate_research_packs.py`. Sửa tay sẽ bị ghi đè — muốn đổi nội dung thì sửa JSON rồi chạy lại script.

**English:** Design of a Complete Embedded Control and Data-Acquisition System

**Nhóm:** `A6` — Hệ nhúng và tích hợp SoC (Embedded Systems & SoC Integration)
**Loại:** `T` — Đồ án tốt nghiệp · **Sàn năng lực:** L2 · **Mã ngắn khóa hiện tại:** `C1`
...
Working embedded system >=2 peripherals; RTOS/clear SW architecture; system tests; performance/reliability; thesis
