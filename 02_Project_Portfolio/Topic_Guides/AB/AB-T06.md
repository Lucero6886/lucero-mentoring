# AB-T06 — Bộ giải mã SC Polar tiết kiệm năng lượng cho liên kết IoT

**Engineering & Research Mentoring Program (Lucero)** · ThS. Đinh Văn Nam (Mr. Lucero Dinh) — Khoa Điện–Điện tử, Trường Kỹ thuật, Đại học Phenikaa

> **File sinh tự động** từ `06_Data/research_packs.json` bằng `scripts/generate_research_packs.py`. Sửa tay sẽ bị ghi đè — muốn đổi nội dung thì sửa JSON rồi chạy lại script.

**English:** Energy-Efficient SC Polar Decoder for an IoT Link

**Nhóm:** `AB` — Vùng giao: IC số × Polar × Edge co-design (Digital IC × Polar / Edge Co-Design)
**Loại:** `T` — Đồ án tốt nghiệp · **Sàn năng lực:** L3 · **Mã ngắn khóa hiện tại:** `C6`
...
Fixed-point SC in IoT context; BLER + energy/bit + latency; comparative evaluation
