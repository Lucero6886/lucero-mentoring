# A2-T03 — Thiết kế và đánh giá PPA của các kiến trúc bộ cộng số học

**Engineering & Research Mentoring Program (Lucero)** · ThS. Đinh Văn Nam (Mr. Lucero Dinh) — Khoa Điện–Điện tử, Trường Kỹ thuật, Đại học Phenikaa

> **File sinh tự động** từ `06_Data/research_packs.json` bằng `scripts/generate_research_packs.py`. Sửa tay sẽ bị ghi đè — muốn đổi nội dung thì sửa JSON rồi chạy lại script.

**English:** Design and PPA Evaluation of Digital Adder Architectures

**Nhóm:** `A2` — Số học số và phần cứng DSP (Digital Arithmetic & DSP Hardware)
**Loại:** `T` — Đồ án tốt nghiệp · **Sàn năng lực:** L2 · **Mã ngắn khóa hiện tại:** `A8`
...
RCA/CLA/carry-select/optional parallel-prefix; equivalence tests; synthesis/STA cùng constraint; PPA analysis
