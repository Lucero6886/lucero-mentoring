# A7-T01 — Thiết kế và đánh giá hệ thống giám sát IoT đa nút hoàn chỉnh

**Engineering & Research Mentoring Program (Lucero)** · ThS. Đinh Văn Nam (Mr. Lucero Dinh) — Khoa Điện–Điện tử, Trường Kỹ thuật, Đại học Phenikaa

> **File sinh tự động** từ `06_Data/research_packs.json` bằng `scripts/generate_research_packs.py`. Sửa tay sẽ bị ghi đè — muốn đổi nội dung thì sửa JSON rồi chạy lại script.

**English:** Design and Evaluation of a Complete Multi-Node IoT Monitoring System

**Nhóm:** `A7` — Hệ IoT và trí tuệ biên (IoT Systems & Edge Intelligence)
**Loại:** `T` — Đồ án tốt nghiệp · **Sàn năng lực:** L2 · **Mã ngắn khóa hiện tại:** `C2`
...
>=3 battery nodes + gateway + dashboard; uptime/loss/battery-life evaluation; thesis; reproducible repo
